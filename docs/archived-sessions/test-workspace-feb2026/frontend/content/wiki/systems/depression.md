...
**Type**: Central Balance State  
**System**: [[enact-dialogue-system|ENACT/Dialogue System]]

## Description

Energy conservation, withdrawal, signaling need for community support

## Symbol Image

![DEPRESSION](/symbols/DEPRESSION.png)

_Visual representation of the DEPRESSION affect in the ENACT system._

## Usage in Dialogue System

This central state represents a fundamental human emotional expression within
the ENACT/Dialogue System. It affects:

- **Character Behavior**: NPCs with high depression weighting will express this
