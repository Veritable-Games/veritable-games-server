...
- `/src/lib/forums/__tests__/validation.test.ts` - Comprehensive test suite (467
  lines)
...
**Allowed Tags:** Text formatting, structure, lists, tables, headings, links,
...
- `Err({ message: 'Validation failed', details: [...] })` - Zod validation
  errors
